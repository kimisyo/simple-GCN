...
from simpleGCN.feat.features import atom_features, bond_features
...
class MolGraph(object):
    ...
    def new_node(self, ntype, features=None, rdkit_ix=None, labels=None):
        new_node = Node(ntype, features, rdkit_ix, labels=labels)
...
class Node(object):
    __slots__ = ['ntype', 'labels', 'features', '_neighbors', 'rdkit_ix']

    def __init__(self, ntype, features, rdkit_ix, labels=None):
        self.ntype = ntype
...
def graph_from_mol(mol, atom_labels=None, atom_features_exp=None):
    ...
    for atom in mol.GetAtoms():
        ...
        if atom_labels:
            ...
            new_atom_node = graph.new_node('atom', features=features, rdkit_ix=atom.GetIdx())
